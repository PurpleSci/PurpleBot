...
class Help(commands.Cog):
    ...
    async def help(self,ctx):
        ...
        embed.add_field(name="Fun", value=f"`crabrave, die, hello, piglatin, pog, predict, randnum, rick, sans, say`", inline=False)
        embed.add_field(name="Science & Math", value=f"`add, subtract, multiply, divide, power, sqrt, pi, weather`", inline=False)
